...
import { useRouter, usePathname } from "next/navigation"; // useSearchParams tidak terpakai, bisa dihapus
import { useSession } from "next-auth/react"; // Tambahkan useSession di sini
...
export const SelectedDeviceProvider = ({
  ...
  const { data: session, status: sessionStatus } = useSession(); // Gunakan session untuk fetch
